...
from ...meta import DEPLOY_ACTION_NAME
from ...meta import DEPLOY_FILE_CONTENTS
from ...meta import DEPLOY_FILE_NAME
from ...meta import LINUX_QUERY
from ...meta import SHELL_ACTION_CMD
from ...meta import SHELL_ACTION_NAME
...
class TestRunActionPrivate(TestRunActionBase):
    ...
    def test_private_shell(self, apiobj, api_devices):
        ...
        data = apiobj._shell(
            action_name=SHELL_ACTION_NAME,
            ids=ids,
            command=SHELL_ACTION_CMD,
        )
        assert not data
